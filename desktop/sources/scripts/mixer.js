...
export default function Mixer (pilot) {
  ...
  this.install = function (host) {
    ...
    // AM
    this.channels[0] = new ChannelInterface(pilot, 0, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 1.25, 'oscillator': { 'type': 'sine8' }, 'modulation': { 'type': 'sine' } }))
    this.channels[1] = new ChannelInterface(pilot, 1, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 1.5, 'oscillator': { 'type': 'triangle8' }, 'modulation': { 'type': 'sawtooth' } }))
    this.channels[2] = new ChannelInterface(pilot, 2, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 1.75, 'oscillator': { 'type': 'sawtooth8' }, 'modulation': { 'type': 'triangle' } }))
    this.channels[3] = new ChannelInterface(pilot, 3, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 2, 'oscillator': { 'type': 'square8' }, 'modulation': { 'type': 'square' } }))
    this.channels[4] = new ChannelInterface(pilot, 4, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 1.25, 'oscillator': { 'type': 'sine4' }, 'modulation': { 'type': 'square8' } }))
    this.channels[5] = new ChannelInterface(pilot, 5, new Tone.PolySynth(8, Tone.AMSynth, { 'harmonicity': 1.5, 'oscillator': { 'type': 'triangle4' }, 'modulation': { 'type': 'sawtooth8' } }))

    // FM
    this.channels[6] = new ChannelInterface(pilot, 6, new Tone.PolySynth(8, Tone.FMSynth, { 'harmonicity': 1.75, 'modulationIndex': 10, 'oscillator': { 'type': 'sawtooth4' }, 'modulation': { 'type': 'triangle8' } }))
    this.channels[7] = new ChannelInterface(pilot, 7, new Tone.PolySynth(8, Tone.FMSynth, { 'harmonicity': 2, 'modulationIndex': 20, 'oscillator': { 'type': 'square4' }, 'modulation': { 'type': 'sine8' } }))
    this.channels[8] = new ChannelInterface(pilot, 8, new Tone.PolySynth(8, Tone.FMSynth, { 'harmonicity': 0.5, 'modulationIndex': 30, 'oscillator': { 'type': 'sine' }, 'modulation': { 'type': 'sawtooth4' } }))
    this.channels[9] = new ChannelInterface(pilot, 9, new Tone.PolySynth(8, Tone.FMSynth, { 'harmonicity': 2.5, 'modulationIndex': 40, 'oscillator': { 'type': 'sine' }, 'modulation': { 'type': 'triangle8' } }))
